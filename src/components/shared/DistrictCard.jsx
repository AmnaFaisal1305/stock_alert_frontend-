      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <h3 className="font-bold text-text text-sm leading-tight truncate" title={district.name}>{district.name}</h3>
            <p className="text-xs text-text-muted mt-1 font-semibold">{district.facilityCount} {district.facilityCount === 1 ? 'facility' : 'facilities'}</p>
          </div>
        </div>
